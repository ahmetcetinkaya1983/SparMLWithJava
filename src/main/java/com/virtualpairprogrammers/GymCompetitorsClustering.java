...
public class GymCompetitorsClustering {
	...
	public static void main(String[] args) {
		...
		for (int noOfClusters = 2; noOfClusters <= 8; noOfClusters++) {
			...
			System.out.println("SSE is :" + model.computeCost(inputData)); // Sum of Squared error
			ClusteringEvaluator evaluator = new ClusteringEvaluator();
			System.out.println("Slihuette with squared euclidean distance is " + evaluator.evaluate(predictions));// close to +1 is better
